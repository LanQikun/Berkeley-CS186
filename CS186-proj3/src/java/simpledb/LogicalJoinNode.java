...
public class LogicalJoinNode {
    ...
    /**
     * The second table to join (may be null). It's the alias of the table, (if
     * no alias, the true table name).
     */
    ...
    public LogicalJoinNode(String table1, String table2, String joinField1,
            String joinField2, Predicate.Op pred) {
        t1Alias = table1;
        t2Alias = table2;
    ...
    public LogicalJoinNode swapInnerOuter() {
        ...
        LogicalJoinNode j2 = new LogicalJoinNode(t2Alias, t1Alias, f2PureName, f1PureName,
                newp);
        return j2;
    }
    ...
    @Override
    public int hashCode() {
        return t1Alias.hashCode() + t2Alias.hashCode() + f1PureName.hashCode()
                + f2PureName.hashCode();
    }
}
