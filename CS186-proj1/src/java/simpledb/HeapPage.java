...
public class HeapPage implements Page {
    ...
    public void deleteTuple(Tuple t) throws DbException {
        for (int i = 0; i < tuples.length; i++) {
            if (this.isSlotUsed(i) && tuples[i].equals(t)) {
                markSlotUsed(i, false);
                return;
            }
        }
        throw new DbException("tuple" + t + "is not on this page, or tuple slot is already empty");
    }
     ...
     */
    private void markSlotUsed(int i, boolean set) {
        int index = (int) (i / 8);
        // 取bits的右数第i%8位（从0算起）
        int pos = i % 8;
        if (set) {
