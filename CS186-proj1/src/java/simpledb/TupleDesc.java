...
public class TupleDesc implements Serializable {
    ...
    */
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        TDItem[] items1 = td1.items;
        TDItem[] items2 = td2.items;
        List<TDItem> both = new ArrayList<TDItem>(items1.length + items2.length);
        Collections.addAll(both, items1);
        Collections.addAll(both, items2);
        return new TupleDesc(both.toArray(new TDItem[both.size()]));
    }
