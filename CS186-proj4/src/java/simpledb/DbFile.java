...
public interface DbFile extends Serializable {
     ...
     *             if the page does not exist in this file.
     */
     ...
     *
     * @param p
     *            The page to write. page.getId().pageno() specifies the offset
     ...
     * method will acquire a lock on the affected pages of the file, and may
     ...
     *
     * @throws DbException
     *             if the tuple cannot be deleted or is not a member of the file
     */
     ...
     * the same value for a particular HeapFile. A simple implementation is to
     * use the hash code of the absolute path of the file underlying the
     * HeapFile, i.e. <code>f.getAbsoluteFile().hashCode()</code>.
     *
